describe('launch a search', () => {
    it('Verify login in page', () => {
      ...
      cy.get('input[type=email]').type('ndiaz+carrier527@smarthop.co');
      ...
      cy.get(':nth-child(3) > .jss1216 > .material-icons').click();
      cy.get('a[href="/search"]').click();
      cy.wait(100)
      cy.get('svg.jss1385').click('topLeft' , { multiple: true });
